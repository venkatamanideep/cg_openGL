...
void CohenSutherlandLineClipAndDraw(GLfloat x0, GLfloat y0, GLfloat x1, GLfloat y1)
{
...
void display()
{
	//GLfloat x0 = 60, y0 = 20, x1 = 80, y1 = 120;
	...
	*/
	...
	for (int i = 0; i < n; i++)
		CohenSutherlandLineClipAndDraw(ls[i].x0, ls[i].y0, ls[i].x1, ls[i].y1);
	glFlush();
}
void myinit()
{
